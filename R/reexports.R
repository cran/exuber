...
#' @seealso \code{\link{fortify.radf_obj}}
#' \code{\link{fortify.ds_radf}}
#' @export
ggplot2::fortify

#' @importFrom ggplot2 autoplot
#' @seealso \code{\link{autoplot.radf_obj}}
#' \code{\link{autoplot.ds_radf}}
#' @export
ggplot2::autoplot
...
#' @seealso \code{\link{tidy.radf_obj}}
#'  \code{\link{tidy.radf_cv}}
#'  \code{\link{tidy.radf_distr}}
#' @export
generics::tidy

#' @importFrom generics augment
#' @seealso \code{\link{augment.radf_obj}}
#'  \code{\link{augment.radf_cv}}
#' @export
generics::augment
